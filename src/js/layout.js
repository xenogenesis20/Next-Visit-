...
import DashboardVisitDetails from "./views/DashboardVisitDetails";
	...
	return (
		<BrowserRouter basename={basename}>
			<Switch>
				...
				<Route exact path="/DashboardVisitDetails/:index">
					<DashboardVisitDetails loggedIn={loggedIn} setLoggedIn={setLoggedIn} />
				</Route>
